...
Distributed parity: The info that can correct errors if a disk is broken is stored in all disks in the array. This means that if one disk is damaged the data can still be recoved as long as there is only one broken disk. 
